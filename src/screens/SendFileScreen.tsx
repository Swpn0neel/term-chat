    ...
    <AppShell>
      <AppShell.Header>
        <Box flexDirection="column" padding={1}>
          ...
          <Breadcrumbs items={['Main Menu', 'File Transfer', 'Send File']} username={user.username} />
        </Box>
      </AppShell.Header>
      ...
      <AppShell.Content>
        <Box padding={1} flexDirection="column">
            ...
            <>
              {stage === 'PATH' && (
                <Box flexDirection="column" flexGrow={1}>
                  <Text bold color={theme.colors.secondary}>Enter File or Folder Path:</Text>
          ...
          {stage === 'UPLOADING' && (
            <Box flexDirection="column" gap={1}>
              <Text bold color={theme.colors.secondary}>Uploading to Cloud...</Text>
              <Box gap={1}>
              ...
              <Text color={theme.colors.mutedForeground} dimColor>{prettyBytes(fileSize)} · {path.basename(finalPath!)}</Text>
            </Box>
          )}
